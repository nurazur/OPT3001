...
void loop()
{
    ...
    if (nonblockingSingleShot(&result_lux))
    {
...
// this method is non-blocking. While the measurement is ongoing 
// other tasks can be performed.
...
void loop()
{
    ...
    if(done)
    {   
        done = false; running = false; // prepare next measurement
        digitalWrite(LED, LOW);
        delay (3000); // alternatively: sleep
    }
}
*/
